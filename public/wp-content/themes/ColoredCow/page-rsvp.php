...
<body>
	<div class="container">
	<br>
	<div class="card-title text-center thank-you-text">You've Confirmed your presence, Thank You! </div>
    <hr>
        <div class="guest-details text-center">
            ...
            <a href="<?php echo home_url(); ?>" class="btn btn-success btn-lg ">Back to Home</a>
        </div>
    </div>
</body>
<br>
